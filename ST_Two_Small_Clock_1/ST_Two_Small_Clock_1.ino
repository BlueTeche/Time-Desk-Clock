...
//BY: JOHN LEE(CUNY ID:23021212)
//DEC 2018
//VERIZON 2.9V
//
//Brief:
//Sketch used in the Solder: Time Desk Clock kit, more info and build instructions at John.Lee2@mail.citytech.cuny.edu
//
//
// 
// Changes:
...
// D. Added Servo(,Bluetooth,ultrasonic,temperutre & Humitidy
